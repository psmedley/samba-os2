...
def gxx_modifier_os2knix(conf):
	v = conf.env
	v.cxxprogram_PATTERN    = '%s.exe'
	v.LINKFLAGS_cxxprogram   = ['-Zexe', '-Zomf','-Zbin-files', '-Zmap', '-static-libgcc', '-lgpg-error', '-lbz2', '-llzma', '-lcrypto', '-lxml2', '-lcx', '-lacl', '-lattr', '-lgnutls', '-licuuc', '-llibstdc++', '/extras/lib/iconv.a', '-lintl', '-ltinfo', '-lnettle']
